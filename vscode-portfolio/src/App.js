      ...
      <Router>
        ...
        <div className="explorer">
          <ul className='explorer-files'>
            <li><Link to="/" className="file-tab">Home</Link></li>
            <li><Link to="/about" className="file-tab">About</Link></li>
            <li><Link to="/projects" className="file-tab">Projects</Link></li>
            <li><Link to="/resume" className="file-tab">Resume</Link></li>
            <li><Link to="/contact" className="file-tab">Contact</Link></li>
          </ul>
        </div>
